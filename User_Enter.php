                ...
                <div class="w3-row">
                    <div class="w3-card-4 w3-col s7 w3-margin-top">
                        <div class="w3-container ">
                            <div class="row w3-margin"><i class="fa fa-user" style="font-size:40px">&nbsp</i><h2>Add User</h2> </div><hr/>
                        </div>
                        <div class="w3-container">
                            <form  action="config/userReg.php" id="form1" method="post">

                                <div class="w3-padding">
                                    <input class="w3-input w3-border" name="empID" type="text" placeholder="Employee ID" data-validation="required"></div>
                                ...
                                <div class="w3-half w3-padding">      
                                    ...
                                    <input class="w3-input w3-border" name="lname" type="text" placeholder="Last Nmae" data-validation="required"></div>

                                <div class="w3-padding">
                                    <input class="w3-input w3-border" name="email" type="text" placeholder="Email" data-validation="email"></div>
                                <div class="w3-padding">
                                    <input class="w3-input w3-border" name="mobil" type="number" placeholder="Telephone No" id='mobile-num' data-validation="required"><span id="folio-invalid" class="hidden mob-helpers" style="color:#B52323"></span></div>
                                <div class="w3-padding">
                                ...
                                <div class="w3-padding ">
                                    <button class="w3-btn w3-block w3-black w3-margin-bottom w3-padding-large" type="submit" name="submit" value="submit">  <i class="fa fa-spinner fa-spin fa-3x fa-fw" id="load"></i> Register</button></div>
                            </form>
