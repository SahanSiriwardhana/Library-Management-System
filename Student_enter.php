            ...
            <div class="container" style="padding-top:50px">
                ...
                <div class="w3-row">
                    <div class="w3-card-4 w3-col s7 w3-margin-top">
                        ...
                        <div class="w3-container">
                            <form  action="config/stdReg.php" id="form1" method="post">


                                <div class="w3-padding">
                                    <input class="w3-input w3-border" name="stdID" type="text" placeholder="Student ID" data-validation="required"></div>
                                ...
                                <div class="w3-padding">
                                    <input class="w3-input w3-border" name="telephone" type="number" placeholder="Telephone Number" id='mobile-num' data-validation="required"><span id="folio-invalid" class="hidden mob-helpers" style="color:#B52323"></span></div>
                                <div class="w3-padding">
                                    <textarea class="w3-input w3-border" placeholder="Address" name="address" data-validation="required"></textarea ></div>
                                <div class="w3-padding">
...
<?php while ($row1 = mysqli_fetch_array($result1)) {
    ?>
                                            <option value="<?php echo $row1['deg_id']; ?>"><?php echo $row1['deg_name']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
