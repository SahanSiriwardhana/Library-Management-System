...
$queary = "SELECT * FROM `user_requsted_book` ORDER BY `user_requsted_book`.`book_title` ASC ";
                ...
                <div class="w3-row">
                    <div class="w3-card-4 w3-col s12 w3-margin">
                        <div class="w3-container w3-padding">
                            <div class="row" style="padding-left:16px"><i class="fa fa-book" style="font-size:40px">&nbsp&nbsp</i> <h2>Requested Books From Members</h2> </div><hr/>
                        </div>
                        ...
                        <table class="table table-striped table-bordered" id="example">
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row["requsested_user_id"]; ?></td>
                    ...
                    $.ajax({
                        ...
                        data: {id: this.name}
                            ...
                            .done(function (msg) {
                                ...
                                window.location = 'Request_from_members.php';
                            });
                }
            });
        });
