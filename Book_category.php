...
<html lang="en"><head>
        ...
        <script type="text/javascript">
            ...
            $('#update').click(function () {
                ...
                $("#myModal1").modal("hide");
                window.location = 'Book_category.php';
                //location.reload();
            });
        </script>
    </head>
                ...
                <div class="w3-row">
                    <div class="w3-card-4 w3-col s12 w3-margin">
                        <div class="w3-container w3-padding">
                            <div class="row" style="padding-left:16px"><i class="fa fa-book" style="font-size:40px">&nbsp&nbsp</i> <h2>Book Category</h2> </div><hr/>
                        </div>
                            ...
                            <form  action="GET" id="">
                                ...
                                <div class="row w3-section">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input class="w3-input w3-border " name="first" type="text" placeholder="Category ID" id="myInputTextField"></div>
                                    <div class="col-sm-3">
                                        <input class="w3-input w3-border " name="first" type="text" placeholder="Category Name" id="myInputTextField2"></div>

                            </form>
                            <div class="col-sm-3 float-right">
                                <button class="w3-btn w3-block w3-red w3-margin-bottom w3-padding" type="button"  data-toggle="modal" data-target="#myModale" id="mod"><i class="fa fa-plus"></i>&nbsp;Add New</button></div>
                        </div>
                        <div class="modal fade" id="myModale"  aria-hidden="true">
                            <div class=" w3-card modal-dialog" role="document">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-book"></i> Add New Category</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form method="post" id="form" action="config/Book_category_engin.php" >
                                            <input class="w3-input w3-border " name="CatName" type="text" placeholder="Category Name" id="CatName" >
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="submit" class="w3-btn  w3-red w3-margin-bottom w3-padding" id="add" value="add" name="submit"></form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <table class="table table-striped table-bordered" id="example">
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><a class="openModal1" data-toggle="modal" data-target="#myModal" data-id="<?php echo $row['cate_id'] ?>" style="cursor:pointer"><i class="fa fa-pencil" style="font-size:24px;color:blue;" ></i></a> &nbsp;<a href="#" data-toggle="tooltip" title="Delete This Book Category" id="delete_cate_<?php echo $row["cate_id"]; ?>" onClick="del();" name="<?php echo $row["cate_id"]; ?>"><i class="fa fa-trash-o" aria-hidden="true" style="font-size:24px;color:red"></i></a></td>
                                </tr>
                            <?php } ?>
    ...
    <div  class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content" id="">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-book"></i> Update Category</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function ($) {
            ...
            $("[id^='delete_cate']").click(function (event) {
                event.preventDefault();
                // var data = table.columns(2).("[id^='delete_cate']").data();
                //alert(data);
                if (confirm('Are you sure delete this Book Category ?')) {
                    $.ajax({

                        method: "POST",
                        url: "config/delete_book_cat.php",
                        data: {id: this.name}
                    })
                            .done(function (msg) {
        ...
        $('.openModal1').click(function () {
            ...
            $.ajax({url: "test.php?id=" + id, cache: false, success: function (result) {
...
//  window.location='Faculty.php';
    ...
    <script type="text/javascript" src="script/newCat.js"></script>
</body>
