...
<?php
$queary = "SELECT * FROM `log_detalis` ORDER BY `log_detalis`.`loged_date&time` DESC ";
                ...
                <div class="w3-row">
                    ...
                    <div class="w3-card-4 w3-col s12 w3-margin">
                        <div class="w3-container w3-padding">
                            <div class="row" style="padding-left:16px"><i class="fa fa-sign-in" style="font-size:40px">&nbsp&nbsp</i> <h2>Loged Details</h2> </div><hr/>
                        </div>
                        <div class="w3-container">
                          <form  action="GET" id="form">
                                ...
                                <div class="row w3-section">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="w3-input w3-border " name="first" type="text" placeholder="Date " id="myInputTextField2"></div>
                        ...
                        <table class="table table-striped table-bordered" id="example">
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row["loged_date&time"]; ?></td>
                                    <td><?php echo $row["loged_ip"]; ?></td>
                                </tr>
<?php } ?>
