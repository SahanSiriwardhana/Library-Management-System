...
$queary = "SELECT * FROM issue_details i,book b,book_category c,lend_cate l WHERE b.book_id=i.book_id AND b.category=c.cate_id AND l.id=b.book_type ORDER BY i.issued_date DESC;";
                        ...
                        <div class="w3-container">
                            <form  action="GET" id="form">
                                <div class="row" style="margin-left:10px">
                                    <button class="w3-btn w3-block w3-red w3-margin-bottom col-md-3" type="button" onClick= "window.location.href = 'Issue_Book.php';"><i class="fa fa-plus"></i>&nbsp;Add New</button></div>
                                <div class="row w3-section w3-margin">
                                    ...
                                    <div class="w3-col s2">
                                        <input class="w3-input w3-border " name="first" type="text" placeholder="Book ID" id="isbn"></div><div class="w3-col s2">
                                        <input class="w3-input w3-border " name="first" type="text" placeholder="Book Title" id="title"></div>
